...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_component__$5 = /*#__PURE__*/normalizeComponent(
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                emojis
                    .filter(function (_a) {
                    var emoji = _a.data;
                    return !(_this.exceptEmojis.findIndex(function (el) { return emoji === el; }) > -1);
                })
    ...
    Object.defineProperty(VEmojiPicker.prototype, "categoriesFiltered", {
        get: function () {
            var _this = this;
            return this.customCategories.filter(function (category) { return !_this.exceptCategories.includes(category.label); });
        },
        enumerable: false,
        configurable: true
    });
...
var __vue_staticRenderFns__$6 = [];
  ...
  const __vue_inject_styles__$6 = function (inject) {
    if (!inject) return
    inject("data-v-959562ca_0", { source: ".emoji-picker[data-v-959562ca]{--ep-color-bg:#f0f0f0;--ep-color-sbg:#f6f6f6;--ep-color-border:#e4e4e4;--ep-color-text:#4a4a4a;--ep-color-active:#009688;display:inline-flex;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeSpeed;flex-direction:column;align-items:center;background-color:var(--ep-color-bg);border-radius:4px;border:1px solid var(--ep-color-border);overflow:hidden;width:325px;user-select:none}@media screen and (max-width:325px){.emoji-picker[data-v-959562ca]{width:100%}}.dark[data-v-959562ca]{--ep-color-bg:#191B1A;--ep-color-sbg:#212221;--ep-color-border:#3E3D42;--ep-color-text:#f0f0f0;--ep-color-active:#009688}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$6 = "data-v-959562ca";
  /* module identifier */
...
};exports.VEmojiPicker=__vue_component__$6;exports.categoriesDefault=categoriesDefault;exports.default=plugin;exports.emojisDefault=emojisDefault;